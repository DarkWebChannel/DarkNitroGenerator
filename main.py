    ...
    def main(self):  # The main function contains the most important code
        ...
        if os.name == "nt":  # If the system is windows
            ...
            ctypes.windll.kernel32.SetConsoleTitleW(
                "DarkNitro - By DarkWeb")  # Change the
        else:  # Or if it is unix
            print(f'\33]0;DarkNitro - By DarkWeb\a',
...
╚═════╝░╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚══╝╚═╝░░░╚═╝░░░╚═╝░░╚═╝░╚════╝░  """)  # Print the title card
        ...
        self.slowType("Made by: DarkWeb", .02)
        ...
        for s in c:  # Loop over the amount of codes to check
            ...
            if os.name == "nt":  # If the system is windows
                ctypes.windll.kernel32.SetConsoleTitleW(
                    f"DarkNitro{len(valid)} Valid | {invalid} Invalid By DarkWeb")  # Change the title
                print("")
            else:  # If it is a unix system
                # Change the title
                print(
                    f'\33]0;DarkNitro {len(valid)} Valid | {invalid} Invalid - By DarkWeb\a', end='', flush=True)
